        ...
        match theme {
            Theme::Dark => {
                match self {
                    ...
                    CssClass::NavLink => "p-3 nav-link font-bold text-lg hover:bg-gray-700 rounded-lg transition-all duration-300",
                    ...
                    CssClass::NavThemeSelect => "mr-3 p-3 bg-transparent font-bold text-md hover:bg-gray-700 rounded-lg transition-all duration-300",
                }
            }
            Theme::Ig => {
                match self {
                    ...
                    CssClass::NavLink => "p-3 nav-link font-bold text-lg hover:bg-indigo-700 rounded-lg transition-all duration-300",
                    ...
                    CssClass::NavThemeSelect => "mr-3 p-3 bg-transparent hover:bg-pink-700 font-bold text-md rounded-lg transition-all duration-300",
                }
            }
            Theme::Twitter => {
                match self {
                    ...
                    CssClass::NavLink => "p-3 nav-link font-medium text-lg hover:bg-blue-700 rounded transition-all duration-300",
                    ...
                    CssClass::NavThemeSelect => "mr-3 p-3 bg-transparent font-medium text-md hover:bg-blue-700 rounded transition-all duration-300",
                }
            }
        }
    }
